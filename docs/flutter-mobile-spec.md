...
3. Las cookies del refresh token ya están persistidas por `CookieJar`
...
- Preview → confirmar
- → `POST /v1/actas/importar/preview` → `POST /v1/actas/importar/confirmar`
...
| DELETE | `/v1/auth/sessions/others` | Cerrar todas las demás |
...
| Método | Endpoint | Descripción |
|---|---|---|
| GET | `/v1/socios` | Listar (paginado, filtrable) |
| GET | `/v1/socios/{id}` | Detalle |
| GET | `/v1/socios/me` | Mi perfil |
| POST | `/v1/socios` | Crear socio |
| PUT | `/v1/socios/{id}` | Editar socio |
| PATCH | `/v1/socios/me` | Actualizar mi perfil |
| PATCH | `/v1/socios/{id}/habilitar` | Habilitar |
| PATCH | `/v1/socios/{id}/inhabilitar` | Inhabilitar |
| PATCH | `/v1/socios/{id}/rol` | Cambiar rol |
| PATCH | `/v1/socios/{id}/nivel-tecnico` | Cambiar nivel |
| PATCH | `/v1/socios/{id}/jefe-montana` | Toggle jefe de montaña |
| DELETE | `/v1/socios/{id}` | Eliminar |
| POST | `/v1/socios/{id}/reenviar-invitacion` | Reenviar invitación |
| POST | `/v1/socios/{id}/emergency-reset` | Reset de emergencia |
| GET | `/v1/socios/lookups` | Catálogos |
| GET | `/v1/socios/{id}/cuotas` | Cuotas del socio |
| POST | `/v1/socios/{id}/cuotas` | Registrar pago |
| DELETE | `/v1/socios/{id}/cuotas/{cuotaId}` | Eliminar cuota |
| POST | `/v1/socios/habilitacion/csv` | CSV habilitación masiva |
| POST | `/v1/socios/importar/preview` | Preview CSV import |
| POST | `/v1/socios/importar/confirmar` | Confirmar CSV import |
| GET | `/v1/socios/invitaciones` | Invitaciones pendientes |
| POST | `/v1/socios/invitaciones/{id}/reenviar` | Reenviar invitación |
| DELETE | `/v1/socios/invitaciones/{id}` | Eliminar invitación |
...
| GET | `/v1/mountains/lookups` | Catálogos |
| GET | `/v1/mountains/acceso-por-nivel` | Matriz acceso |
| PUT | `/v1/mountains/acceso/{id}` | Actualizar acceso |
...
| POST | `/v1/actas/{id}/informes` | Vincular informe |
| DELETE | `/v1/actas/{id}/informes/{iId}` | Desvincular informe |
| POST | `/v1/actas/importar/preview` | Preview CSV |
| POST | `/v1/actas/importar/confirmar` | Confirmar CSV |
| POST | `/v1/actas/{id}/pdf` | Generar PDF |
...
| Método | Endpoint | Descripción |
|---|---|---|
| GET | `/v1/admin/config` | Configuración del sistema |
| PATCH | `/v1/admin/config` | Actualizar configuración |
| GET | `/v1/admin/auditoria` | Log de auditoría |
| GET | `/v1/admin/security-events` | Eventos de seguridad |
| GET | `/v1/admin/usuarios-auth` | Listar usuarios |
| GET | `/v1/admin/usuarios-auth/{id}` | Detalle usuario |
| POST | `/v1/admin/usuarios-auth/{id}/desbloquear` | Desbloquear |
| PATCH | `/v1/admin/usuarios-auth/{id}/estado-acceso` | Cambiar estado acceso |
| POST | `/v1/admin/usuarios-auth/{id}/cerrar-sesion` | Cerrar sesión |
